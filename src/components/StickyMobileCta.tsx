      ...
      <div className="mx-auto flex max-w-lg gap-2">
        {tel && (
          <a
            href={tel}
            aria-label="Appeler"
            onClick={() => track("Phone Click", { from: "sticky" })}
            className="flex h-12 w-12 shrink-0 items-center justify-center rounded-sm bg-signal text-signal-foreground active:scale-[0.97]"
          >
